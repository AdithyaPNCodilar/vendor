...
public function getAdditionalData()
{
    ...
    $customAttributeValue = $product->getCustomAttribute('custom_datapatch')? $product->getCustomAttribute('custom_datapatch')->getValue() : null;
    $attrLabel = $product->getResource()->getAttribute('custom_datapatch')->getStoreLabel();
    $additionalData[] = [
    'attrLabel' => $attrLabel,
